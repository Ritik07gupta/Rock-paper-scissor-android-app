...
class MainApp(App):
    ...
    # def build(self):
    #     layout = GridLayout(cols=2)  # 2 columns
    #     for i in range(4):
    #         button = Button(text=f'Button {i+1}', size_hint=(1, 1))
    ...
    def reset_all(self):
        ...
        self.opp= ""
        self.you= ""
        self.root.ids.play.ids.opponent.source= 'imgs/question mark.png'
        self.root.ids.play.ids.you.source= 'imgs/question mark.jpg'
    ...
    def play(self):
        self.bomb= Clock.schedule_interval(self.change_img, 0.1)
        
    def change_img(self, *args):
        self.clocks+= 1
        if self.clocks <= 20:
            opponent= self.root.ids.play.ids.opponent
            self.one= {1:'imgs/rock.png', 2:'imgs/paper.png', 3:'imgs/scissor.png'}[randint(1,3)]
            ...
            if self.one == 'imgs/rock.png':
                ...
                self.opp= 'paper'
            elif self.one == 'imgs/scissor.png':
                self.opp= 'scissors'
        self.get_res()
